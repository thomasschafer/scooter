...
mod tests {
    ...
    fn test_empty_haystack() {
        ...
        assert_eq!(
            replace_whole_word_if_match_regex("", &add_boundaries(SearchType::Pattern(re)), "NEW"),
            None
        );
    }
    ...
    fn test_single_char() {
        ...
        assert_eq!(
            replace_whole_word_if_match_regex("bac", &add_boundaries(SearchType::Pattern(re)), "X"),
            None
        );
    }
